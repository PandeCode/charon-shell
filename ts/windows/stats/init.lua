...
local ____sysinfo_2Etsx = require("ts.windows.stats.sysinfo")
local Sysinfo = ____sysinfo_2Etsx.default
local ____weather_2Etsx = require("ts.windows.stats.weather")
local Weather = ____weather_2Etsx.default
